---  
title: "Comparison between observed and estimated fishing zones"  
...
This document provide `R` script and data to reproduce the comparison between the spatial distributions of the observed and the estimated descriptors (states, fishing grounds and fishing intensity) for the variegated scallop dredging trip as illustrated in the supplementary figure S5 in Le Guyader *et.al* (2017):
...
> Data and replication `R` code are available in this Github repository: https://github.com/dleguyader/LeGuyader-etal-2016-SM.
...
```{r plot, fig.width=8, fig.height=9.5, fig.cap="Spatial distributions of the observed (left) and the estimated (right) descriptors (states, fishing grounds and fishing intensity) for the variegated scallop dredging trip."}
